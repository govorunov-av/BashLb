...
Простой bash скрипт, предоставляющий возможности резервирования шлюзов, балансировки трафика, а так же автоматического отключения "не рабочего" шлюза.
...
- Кол-во шлюзов - 5
- Кто в роли шлюзов - squid в режиме балансировки по доменам (Мой проект SquidFW)
...
- ~3% cpu
- ~60% mem (тут дело скорее в altlinux, много памяти in cache)
- 2.1GB ssd
```
### Топология
В моем случае получилось подобная топология:
<img width="1454" height="1116" alt="image" src="https://github.com/user-attachments/assets/89f4d644-a4fd-46bb-91bb-adabb1e461ae" />
